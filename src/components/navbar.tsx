...
export default function Example() {
  return (
    <Disclosure as="nav" className="bg-[#E7C8E7] sticky top-0">
        ...
        <div className="relative flex h-16 items-center justify-between">
          <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
            ...
            <DisclosureButton className="group relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
              ...
              <img src="../public/icons/burger.svg" aria-hidden="true" className="block h-6 w-6 group-data-[open]:hidden" />
              <img src="../public/icons/burger.svg" aria-hidden="true" className="hidden h-6 w-6 group-data-[open]:block" />
            </DisclosureButton>
          </div>
                ...
                {navigation.map((item) => (
                  <a
                    ...
                    className={classNames(
                      item.current ? 'bg-[#0D0B33] text-white' : 'text-[#0D0B33] hover:bg-[#4C2F6F] hover:text-white',
